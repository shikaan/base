...
let%expect_test ("space" [@tags "no-js", "disabled"]) =
  ...
  [%expect
    ...
    │       100 │ balanced     │       419 │
    │       100 │ random       │       404 │
    │    10_000 │ l_to_r       │    35_030 │
    │    10_000 │ r_to_l       │    35_030 │
    │    10_000 │ balanced     │    37_742 │
    │    10_000 │ random       │    37_100 │
    │ 1_000_000 │ l_to_r       │ 3_500_030 │
    │ 1_000_000 │ r_to_l       │ 3_500_030 │
    │ 1_000_000 │ balanced     │ 3_572_891 │
    │ 1_000_000 │ random       │ 3_714_581 │
    └───────────┴──────────────┴───────────┘
    |}]
;;
